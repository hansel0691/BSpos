...
namespace OrdersGateway.Controllers
{
    public class OrdersController : ApiController
    {
        ...
        [HttpPost]
        [SkipAuthentication]
        public CommitResponse ExecuteOrderTest()
        {
            var webRequest = new OrdersWebRequest() { MerchantId = 88709, TerminalId = 10070815, SerialNumber = "2020734000000000", OrderNumber = 4967 };
            var isMeteleMerchant = IsMeteleUsaMerchant(webRequest.MerchantId);
